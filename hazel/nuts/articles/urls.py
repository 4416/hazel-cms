...
def build_rules():
    ...
    pub_rules, pub_views, admin_rules, admin_views, admin_tabs = _build_rules()
    if settings.submount:
        pub_rules = [Submount(settings.submount, pub_rules)]
    if settings.subdomain:
        pub_rules = [Subdomain(settings.subdomain, pub_rules)]
    return pub_rules, pub_views, admin_rules, admin_views, admin_tabs
